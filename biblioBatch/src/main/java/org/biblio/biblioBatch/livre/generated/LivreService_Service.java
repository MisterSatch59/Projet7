 ...
 * 2018-06-19T22:18:55.623+02:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "LivreService",
                  wsdlLocation = "file:/C:/dev/eclipse-workspace/biblioBatch/src/main/resources/wsdl/LivreService.wsdl",
...
public class LivreService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/dev/eclipse-workspace/biblioBatch/src/main/resources/wsdl/LivreService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LivreService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/dev/eclipse-workspace/biblioBatch/src/main/resources/wsdl/LivreService.wsdl");
        }
        WSDL_LOCATION = url;
    }
